...
pt2d_srid4326_wkb = "\x01"*  # little endian
...
ls2d_wkt = "LineString(2.2 4.4, 3.1 5.1)"
ls2d_wkb = "\x00"*  # big endian
...
pg2d_wkt = "Polygon((100.001 0.001, 101.12345 0.001, 101.001 1.001, 100.001 0.001),"*
            "(100.201 0.201, 100.801 0.201, 100.801 0.801, 100.201 0.201))"
pg2d_wkb =  "\x00"*
...
pg2d_srid26918_wkb =    "\x00"*  # big endian
...
mpt2d_srid664_wkb = "\x01"*  # little endian
...
mpg2d_srid4326_wkb ="\x01"*  # little endian
...
gc2d_srid1234 = (type="GeometryCollection",
                ...
                meta=(srid=1234,),
                crs=(type="name", properties=(name="EPSG1234",)))
gc2d_srid1234_wkb = "\x00"*  # big endian
